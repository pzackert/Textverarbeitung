# IFB PROFI - MVP (Option 1)

**Legacy MVP zur Validierung von Förderanträgen** mit Streamlit und LM Studio.

> **Hinweis:** Dies ist der ursprüngliche MVP (Option 1). Die Weiterentwicklung findet in `option_2_platform` statt.
